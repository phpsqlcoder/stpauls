...
<div class="container pd-x-0">
    ...
    <form autocomplete="off" action="{{ route('transaction-status.update',$transaction->id) }}" method="post" id="promo_form">
        @csrf
        @method('PUT')
        <div class="row row-sm">
            <div class="col-lg-6">
            	<div class="form-group">
            		...
            		<input required type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name',$transaction->name) }}" maxlength="150">
