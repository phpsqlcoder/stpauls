                            ...
                            <div class="list-search d-inline">
                                <div class="dropdown d-inline mg-r-10">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="approve_reviews()">{{__('common.approve')}}</a>
                        ...
                        <table class="table mg-b-0 table-light table-hover" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr id="row{{$review->id}}">
                                    ...
                                    <td>{{ $review->review }}</td>
                                    <td>{{ $review->rating }}</td>
                                    <td>{{ ($review->is_approved == 1) ? 'APPROVED' : '' }}</td>
                                    <td>
                                        @if($review->trashed())
...
@section('pagejs')
    ...
    <script>
        let listingUrl = "{{ route('product-review.list') }}";
