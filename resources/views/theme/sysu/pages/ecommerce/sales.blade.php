                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        @if($sale->status<>'CANCELLED')
                                            @if ($balance > 0)
                                                <a href="{{route('my-account.pay-again',$sale->id)}}" title="Pay now" class="btn btn-success btn-xs mb-1"><i class="fa fa-credit-card pb-1"></i></a>&nbsp;
                                            @endif
                                            @if($paid <= 0)                                            
                                                <a href="#" title="Cancel Order" onclick="cancel_unpaid_order('{{$sale->order_number}}')" class="btn btn-success btn-xs mb-1"><i class="fa fa-times pb-1"></i></a>&nbsp;
                                            @endif
                                            
                                            <a href="#" title="view delivery history" class="btn btn-success btn-xs mb-1" data-toggle="modal" data-target="#delivery{{$sale->id}}"><i class="fa fa-truck pb-1"></i></a>
                                        @else
                                            <a href="#" title="view items" data-toggle="modal" data-target="#detail{{$sale->id}}" class="btn btn-success btn-xs mb-1"><i class="fa fa-eye pb-1"></i></a>
                                        @endif
                                    </td>
                                </tr>
                                @php
