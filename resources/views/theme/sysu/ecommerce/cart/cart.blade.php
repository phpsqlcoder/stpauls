                ...
                <form method="POST" action="{{route('cart.front.batch_update')}}">
                    ...
                    <div class="row">
                        <div class="col-lg-8 pb-5">
                            <h3 class="catalog-title">My Cart</h3>
                            @php
                                $total = 0;
                            ...
                            @forelse($cart as $key => $order)
                                ...
                                @endphp
                                <input type="hidden" name="record_id[{{$loop->iteration}}]" value="{{$order->id}}">
                                                    ...
                                                    <div class="prod-qty">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-btn">
                                                                <button type="button" class="btn btn-default btn-number minus-btn" disabled="disabled" data-type="minus" data-field="quantity[{{$loop->iteration}}]">
