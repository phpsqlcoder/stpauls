                                ...
                                <div class="col-lg-2">
                                    <div class="product-detail">
                                        @if($product->Maxpurchase > 0)
                                            <div class="w-100">
                                                                ...
                                                                <div class="shopping-cart-quantity">
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn">
                                                                            <button type="button" class="btn btn-default btn-number minus-btn" disabled="disabled" data-type="minus" data-field="quant[1]">
                                                                                <span class="fa fa-minus"></span>
                                                                            </button>
                                                                        </span>
                                                                        <input type="text" name="quant[1]" id="qty1" class="form-control input-number quantity-fld" value="0" min="0" max="{{$product->Maxpurchase}}">
                                                                        <span class="input-group-btn">
                                                ...
                                                <div class="product-btn">
                                                    <a id="b3" href="#"  onclick="add_to_cart({{$product->id}},'qty1');" class="btn btn-lg add-cart-alt2-btn addToCartButton" data-loading-text="processing...">
                                        ...
                                        @else
                                                ...
                                                <div class="listing-bottom row no-gutters px-3 pb-3" style="width:200px;">
