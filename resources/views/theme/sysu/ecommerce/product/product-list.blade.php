                ...
                <div class="row no-gutters">
                    <div class="col-md-12">
                        <div class="main-banner">
                            ...
                            --}}
                            <div class="slick-slider" id="banner" style="height: 100px;">
                                <div class="alert alert-danger text-center" role="alert" style="font-size:25px;">
                                    We are currently on website testing. Watch out for the launch of our new official online store.
                                </div>
                    ...
                    <div class="col-lg-3">
                            ...
                            <div class="desk-cat pb-5 d-none d-lg-block">
                                ...
                                <div class="catalog-category">   
                                    ...
                                    <div class="gap-20"></div> 
                                    <form action="{{ route('product.front.list') }}" id="filter_form" method="POST" class="row">
                                        @csrf
                                            ...
                                            <div class="product-card">
                                                ...
                                                @if($product->Maxpurchase > 0)
                                                    <div class="listing-bottom row no-gutters px-3 pb-3">
                                                            ...
                                                            <div class="shopping-cart-quantity quantity-listing">
                                                                <div class="input-group">
                                                                    <span class="input-group-btn">
                                                                        <button type="button" class="btn btn-default btn-number minus-btn" disabled="disabled" data-type="minus" data-field="quant[{{$loop->iteration}}]">
                                                                            <span class="fa fa-minus"></span>
                                                                        </button>
                                                                    </span>
                                                                    <input type="text" name="quant[{{$loop->iteration}}]" id="qty{{$loop->iteration}}" class="form-control input-number quantity-fld" value="0" min="0" max="{{$product->Maxpurchase}}">
                                                                    <span class="input-group-btn">
                                                        ...
                                                        <div class="rounded">
                                                            <a href="#" onclick="add_to_cart({{$product->id}},'qty{{$loop->iteration}}');" id="btn{{$product->id}}"><i class="fa fa-cart-plus bg-success text-light p-1 rounded"></i></a>
                                                        </div>
                                                    </div>
                                                @else
                                                    <div class="listing-bottom row no-gutters px-3 pb-3">
