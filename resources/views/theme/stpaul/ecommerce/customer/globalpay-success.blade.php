                        ...
                        <div id="form-wrapper">
                            <div class="row">
                                ...
                                <div class="col-md-7 mb-4">
                                    ...
                                    @else
                                    <p class="font-weight-bold">For <b class="text-danger">unpaid orders</b>,please click on <b class="text-danger">MY ORDERS</b> button, and click on <span class="d-inline-block ml-1 mr-1" style="transform:translateY(6px)"><span class="c-icon c-icon-peso-red"></span></span> button to attach your proof of payment.<br><b>To view the status of your order, please click &nbsp;<span class="d-inline-block mr-1" style="transform:translateY(6.5px)"><span class="lnr lnr-eye text-md text-first-color font-weight-bold"></span></span>&nbsp;or&nbsp;<span class="d-inline-block ml-1" style="transform:translateY(2px)"><span class="lnr lnr-car text-md text-first-color font-weight-bold mr-2"></span></span>.</b></p>
                                    @endif
                                </div>
