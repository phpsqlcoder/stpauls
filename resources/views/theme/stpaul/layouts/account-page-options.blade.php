    ...
    <div class="listing-filter-wrap">
        ...
        <div class="side-menu">
            <ul>
                ...
                <li @if(Route::current()->getName() == 'account-my-orders' || Route::current()->getName() == 'account-order-info')  class="active" @endif><a href="{{ route('account-my-orders') }}">My Orders</a></li>
                <li @if(Route::current()->getName() == 'account.manage-wishlist')  class="active" @endif><a href="{{ route('account.manage-wishlist') }}">My Wishlist</a></li>
