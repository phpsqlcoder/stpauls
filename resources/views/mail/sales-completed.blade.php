...
<title>Sysu - Sales Transaction</title>
...
<tr>
    <td class="center" align="center" valign="top">
        ...
        <table class="container content" align="center">
            <tr>
                  <td>
                        <table>
                              <tr>
                                    <td style="text-align: center !important !important;"><img src="https://www.sysuinc.com.ph/includes/img/logo-header.jpg" alt="" /></td>
                              </tr>
                        </table>
        ...
        <tr>
                ...
                <tr>
                    <td class="wrapper last">
                        <h4>Thank you for ordering from us.</h4>
                                    <p>Order number: {{$h->order_number}} </p>
                                    <p>Order date: {{date('F d, Y H:i A',strtotime($h->created_at))}} </p>
                                    <table class="btn green">
                                          <tbody><tr>
                                                <td>
                                                      <a href="{{env('APP_URL')}}/account/sales">Click here to view and manage your orders</a>
                                                </td>
                                          </tr>
                                          </tbody>
                                    </table>
                        <p><br>
                            If the above link does not work, copy and paste the following URL on your browser window.
                        </p>
                        <!-- BEGIN: Note Panel -->
                        <table class="twelve columns" style="margin-bottom: 10px">
                        <tr>
                            <td class="panel">
                                <a href="https://sysu.com">
            ...
            <tr>
                  <td><table class="row note">
                  <tr>
                        <td><p><span style="font-size:12px;">
                  <i>Note: You will receive a separate email for your payment confirmation.</i> | <i>If you wish to cancel this order, please email <a href="mailto:ecommerce@sysuinternational.ph?subject=Order%20Cancellation%20Request%20for%20{{$h->order_number}}">ecommerce@sysuinternational.ph</a>.</i>
            </span></p></td>
                  </tr>
            </table></td>
            </tr>
                ...
                <tr>
                    <td>
                        ...
                        <tr>
                            ...
                            <td class="wrapper last">
                                <table class="eight columns" style="display:none;">
                                <tr>
