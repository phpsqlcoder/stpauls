...
class Setting extends Model
{
    ...
    protected $fillable = ['api_key', 'website_name', 'website_favicon', 'company_logo', 'company_favicon', 'company_name', 
                            ...
                            'data_privacy_popup_content', 'data_privacy_content', 'mobile_no', 'fax_no', 'tel_no', 'viber_no', 'email', 
                            'company_about', 'company_address', 'google_map', 'social_media_accounts', 'copyright', 'user_id',
                            'pickup_is_allowed','delivery_note','review_is_allowed','promo_is_displayed','min_order','min_order_is_allowed','flatrate_is_allowed','delivery_collect_is_allowed','contact_us_email_layout', 'coupon_limit', 'coupon_discount_limit'
                        ];
